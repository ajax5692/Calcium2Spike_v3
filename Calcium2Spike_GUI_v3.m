...
%%% - File Selection Console"
ExperimentFilesUIGroup = uipanel('Title','Project management',...
    'Position',[0.025, 0.42, 0.48, 0.4],'BackgroundColor','White');

% - Save location spacecard
...
% - MESc file selection spacecard
MEScUIGroup = uipanel('Title','MESc file',...
    'Position',[0.030505952380952,0.442063492063488,0.468749999999999,0.21375661375661],'BackgroundColor',[0.75 0.75 0.75]);

generalTB(3) = GenericTextBox(MEScUIGroup);
UISet_C2S(generalTB(3), 'Position', [0.01,0.6,0.974271012006861,0.289855072463767]);
...
UISet_C2S(generalTB(4), 'Position', [0.012006861063465,0.550344827586227,0.974271012006861,0.143708145927016]);
...
MEScParamsUIGroup = uipanel('Title','MESc Params',...
    'Position',[0.035,0.452380952380952,0.457,0.091005291005276],'BackgroundColor',[0.75 0.75 0.75]);


%%% - Analysis Console
AnalysisUIGroup = uipanel('Title','Analysis',...
    'Position',[0.52, 0.42, 0.45, 0.4],'BackgroundColor','white');
...
UISet_C2S(generalTB(6), 'BackGroundColor', 'w');
UISet_C2S(generalTB(6), 'FontSize', 12);
UISet_C2S(generalTB(6), 'FontWeight', 'bold');

generalTB(7) = GenericTextBox(AnalysisUIGroup);
UISet_C2S(generalTB(7), 'Position', [0.015,0.82,0.025,0.07]);
UISet_C2S(generalTB(7), 'String','No file selected')
